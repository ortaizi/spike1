...
import { Award, ChevronDown, ChevronUp, FileText } from 'lucide-react';
            ...
            <table className='w-full text-sm'>
              <thead>
                <tr className='border-b border-slate-200'>
                  <th className='px-2 py-3 text-right font-medium text-slate-700'>מטלה</th>
                  <th className='px-2 py-3 text-center font-medium text-slate-700'>ציון</th>
                  <th className='px-2 py-3 text-center font-medium text-slate-700'>מתוך</th>
                  <th className='px-2 py-3 text-center font-medium text-slate-700'>אחוז</th>
                  <th className='px-2 py-3 text-center font-medium text-slate-700'>סטטוס</th>
                </tr>
              </thead>
              <tbody>
                {mockAssignmentGrades.map((assignment, index) => (
                  ...
                  >
                    ...
                    <td className='px-2 py-3 text-center text-slate-600'>{assignment.maxGrade}</td>
                    <td className='px-2 py-3 text-center font-medium text-slate-900'>
