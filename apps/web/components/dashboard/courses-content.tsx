...
import { ChevronRight, BookOpen, Clock, Award, GraduationCap } from "lucide-react"
...
const mockAnnouncements = [
  {
    ...
    content: "שלום לכולם, ברצוני לעדכן כי מועד בחינת האמצע נדחה בשבוע אחד קדימה. הבחינה תתקיים ביום רביעי 22/03 בשעה 10:00 באולם 101. אנא הכינו את עצמכם בהתאם. הבחינה תכלול את כל החומר שנלמד עד השיעור מיום 15/03. בהצלחה לכולם!",
  ...
  },
  {
    ...
    content: "הועלה תרגיל בית נוסף בנושא אלגוריתמי מיון. התרגיל זמין באתר הקורס ויש להגישו עד יום ראשון הקרוב. התרגיל מהווה 10% מהציון הסופי.",
  ...
  },
  {
    ...
    content: "שימו לב, שעות הקבלה שלי השתנו החל מהשבוע הבא. במקום ימי ב' 14:00-16:00, הקבלה תתקיים בימי ג' 16:00-18:00. אנא עדכנו את לוח הזמנים שלכם בהתאם.",
...
const mockSections = [
  {
    ...
    items: [
      ...
      { id: "3", title: "מטלה 1: אלגוריתמי מיון", type: "assignment" as const, dueDate: "20/03/2025" },
    ],
  },
  {
    id: "2",
    ...
    items: [
      ...
      { id: "5", title: "תרגול 2: יישום אלגוריתמי חיפוש", type: "document" as const, duration: "60 דקות" },
    ],
  },
  {
    id: "3",
...
export function CoursesContent() {
  ...
  const currentCourse = mockCourses.find((course) => course.id === activeCourse)
    ...
    <div className="space-y-2">
      ...
      <div className="mb-8">
        <div className="flex items-center space-x-3 space-x-reverse mb-2">
          ...
          <h1 className="text-3xl font-bold text-black text-right">קורסים</h1>
        </div>
          ...
          {loading ? (
            ...
            <div className="dipy-card dipy-fade-in p-12 text-center">
              <div className="max-w-2xl mx-auto">
                <div className="mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">ברוכים הבאים לעמוד הקורסים!</h2>
                  <p className="text-lg text-gray-600 leading-relaxed">
                    היי! כאן תוכל/י לראות את כל הקורסים הפעילים שלך ואת התכנים שלהם.
                  </p>
                </div>
                <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
                  <h3 className="text-lg font-semibold text-blue-900 mb-3">איך להתחיל?</h3>
                  <div className="text-right space-y-2 text-blue-800">
                    <p className="flex items-center space-x-2 space-x-reverse">
                      <span className="w-6 h-6 bg-blue-200 rounded-full flex items-center justify-center text-sm font-bold">1</span>
                      <span>בחר/י קורס מהרשימה בסרגל הצד</span>
                    </p>
                    <p className="flex items-center space-x-2 space-x-reverse">
                      <span className="w-6 h-6 bg-blue-200 rounded-full flex items-center justify-center text-sm font-bold">2</span>
                      <span>צפה/י בחומרי הלימוד, מטלות ובחינות</span>
                    </p>
                    <p className="flex items-center space-x-2 space-x-reverse">
                      <span className="w-6 h-6 bg-blue-200 rounded-full flex items-center justify-center text-sm font-bold">3</span>
            ...
            <div className="dipy-card dipy-fade-in p-12 text-center">
              <div className="max-w-lg mx-auto">
                ...
                <h2 className="text-xl font-semibold text-gray-900 mb-3">בחר קורס לצפייה</h2>
                <p className="text-gray-600">
                  בחר/י קורס מהרשימה בסרגל הצד כדי לצפות בתכנים שלו
                </p>
              </div>
            </div>
          ) : (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="dipy-card dipy-fade-in dipy-accent-indigo p-6">
                  <HorizontalTeachingStaff key={`teaching-staff-${activeCourse}`} staff={mockStaff} />
                </div>
              ...
              <div className="dipy-card dipy-fade-in dipy-accent-amber p-6">
                <CompactAnnouncements key="compact-announcements" announcements={mockAnnouncements} />
              </div>

              {/* Course Sections Grid */}
              <div className="dipy-card dipy-fade-in dipy-accent-slate p-6">
                <ModernCourseSections key={`course-sections-${activeCourse}`} sections={mockSections} />
              </div>
            </div>
          )}
        </div>
